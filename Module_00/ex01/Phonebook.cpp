...
/*   Updated: 2025/01/11 17:25:20 by roko             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Phonebook::add_new_contact()
{
	...
	for (int i = 0; i < 5; i++)
	{
		if (data[i].size() == 0)
		{
			std::cout << "EMPTY FIELD IN CONTACT --> CONTACT NOT SAVED" << std::endl;
			return ;
		}
	}
	...
	this->contacts_array[latest_index].set_first_name(data[0]);
	this->latest_index++;
}
